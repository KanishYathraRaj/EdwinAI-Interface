# EdwinAI Interface (Frontend): Short Core Logic Summary

## Calendar & Scheduling
- Uses FullCalendar for weekly batch/subject scheduling.
- Custom logic for slot parsing, merging, and rendering.
- Interactive mini-calendar, batch selection, and hover details.

## Main App Logic
- AuthProvider manages authentication state.
- MainLayout organizes subject, tab, and modal flows.
- Handles subject creation, syllabus upload, GCR integration.
- Dynamic content rendering for chat, syllabus, documentation, question bank, and students.

## App Entry Point
- main.tsx mounts App component with StrictMode.
